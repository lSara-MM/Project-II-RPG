...
bool QuestManager::LoadState() {
	...
	else
	{
		...
		app->puzzleManager->BarricadeHasExploted1 = gameStateFile.child("save_state").child("puzzle").attribute("BarricadeExplote1").as_bool();
		app->puzzleManager->BarricadeHasExploted2 = gameStateFile.child("save_state").child("puzzle").attribute("BarricadeExplote2").as_bool();
		app->puzzleManager->BarricadeHasExploted3 = gameStateFile.child("save_state").child("puzzle").attribute("BarricadeExplote3").as_bool();
		app->puzzleManager->BarricadeHasExploted4 = gameStateFile.child("save_state").child("puzzle").attribute("BarricadeExplote4").as_bool();
		app->puzzleManager->BarricadeHasExploted5 = gameStateFile.child("save_state").child("puzzle").attribute("BarricadeExplote5").as_bool();
		...
		app->puzzleManager->CurrentDarkFade = gameStateFile.child("save_state").child("puzzle").attribute("CurrentDarkFade").as_bool();
...
bool QuestManager::SaveState() 
{
	...
	puzzle.append_attribute("BarricadeExplote1") = app->puzzleManager->BarricadeHasExploted1;
	puzzle.append_attribute("BarricadeExplote2") = app->puzzleManager->BarricadeHasExploted2;
	puzzle.append_attribute("BarricadeExplote3") = app->puzzleManager->BarricadeHasExploted3;
	puzzle.append_attribute("BarricadeExplote4") = app->puzzleManager->BarricadeHasExploted4;
	puzzle.append_attribute("BarricadeExplote5") = app->puzzleManager->BarricadeHasExploted5;
	...
	puzzle.append_attribute("CurrentDarkFade") = app->puzzleManager->CurrentDarkFade;
...
bool QuestManager::resetPuzzlesAndQuests() 
{
	...
	app->puzzleManager->CurrentDarkFade = false;
