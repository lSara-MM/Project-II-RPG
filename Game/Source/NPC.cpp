...
bool Npc::Awake() {
	...
	positionMerch.x = parameters.attribute("x").as_int();
	positionMerch.y = parameters.attribute("y").as_int();
...
bool Npc::Update(float dt)
{
	...
	app->render->DrawTexture(texture, positionMerch.x, positionMerch.y, &rect, 1.0f, NULL, NULL, NULL, flipType);
